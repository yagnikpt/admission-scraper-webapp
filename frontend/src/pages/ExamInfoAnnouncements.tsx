...
import { useExamInfoAnnouncements } from "@/hooks/use-announcements";

const PAGE_SIZE = 20;

export default function ExamInfoAnnouncements() {
		...
		<Layout>
			...
			<div className="mb-8 md:mb-12">
				...
				<p className="md:text-lg text-muted-foreground max-w-2xl">
					Find exam-related announcements and schedules from institutions.
				</p>
			</div>
			...
			{error ? (
				...
				<div className="flex flex-col items-center justify-center py-20 text-center bg-card/50 rounded-3xl border border-border/50 border-dashed">
					...
					<h3 className="text-xl font-bold mb-2">No exam info found</h3>
					<p className="text-muted-foreground max-w-sm">
						We couldn't find any exam information matching "{searchTerm}".
					</p>
				</div>
			) : (
				<>
